...
- 62629 observations n'ont pas de marque : a priori, les produits tels que les accessoires n'ont pas de marque. Ainsi, l'absence de donnée concernant la marque est en soit une information qu'il convient de conserver. Pour cela, nous remplaçons les valeurs manquantes par "brand_missing".
...
dataset$brand_name[is.na(dataset$brand_name)] = "brand_missing"
...
dataset$is_brand_missing = dataset$brand_name == "brand_missing" #boolean
```
...
dataset$item_description[is.na(dataset$item_description)] = "No description yet"

# Vérification
n_description_missing = sum(dataset$item_description == "No description yet")
